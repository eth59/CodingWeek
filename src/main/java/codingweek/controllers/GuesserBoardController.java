...
public class GuesserBoardController {
    ...
    private void populateBoard() {
        ...
        for (int row = 0; row < GRID_ROWS; row++) {
            for (int col = 0; col < GRID_COLS; col++) {
                ...
                cardPane.setOnMouseClicked(event -> onTileClicked(cardPane));
    ...
    private void onTileClicked(StackPane tile) {
        tile.setStyle("-fx-border-color: black; -fx-background-color: yellow; -fx-padding: 10;");
    }
}
